<?php
/* Smarty version 4.3.0, created on 2023-06-26 03:24:07
  from 'C:\OpenServer\domains\dipmed\template_engine\template\dir\category.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.0',
  'unifunc' => 'content_6498daa725fce0_66118095',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '780da498bb316fdb29a3503cb503cf7722ce04fe' => 
    array (
      0 => 'C:\\OpenServer\\domains\\dipmed\\template_engine\\template\\dir\\category.tpl',
      1 => 1686517789,
      2 => 'file',
    ),
...
function content_6498daa725fce0_66118095 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="ru">
            ...
            <div class="container category__container">
                <ul class="category__list">
                    <li class="category__item">
                        <a href="/product.php" class="category__link">
                            <div class="category-img__wrapper">
                                <img src="uploads/" alt="" class="category__image">
                            </div>
                            <div class="category-text__wrapper">
                                <span class="category__title">Все категории</span>
                            </div>
                        </a>
                    </li>
                                            <li class="category__item">
                            <a href="/product.php?category=6&name=Зуботехнические материалы" class="category__link">
                                <div class="category-img__wrapper">
                                    <img src="uploads/zubteh.png" alt="" class="category__image">
                                </div>
                                <div class="category-text__wrapper">
                                    <span class="category__title">Зуботехнические материалы</span>
                                </div>
                            </a>
                        </li>
                                            <li class="category__item">
                            <a href="/product.php?category=7&name=Зуботехническое оборудование" class="category__link">
                                <div class="category-img__wrapper">
                                    <img src="uploads/zubtehobor.png" alt="" class="category__image">
                                </div>
                                <div class="category-text__wrapper">
                                    <span class="category__title">Зуботехническое оборудование</span>
                                </div>
                            </a>
                        </li>
                                            <li class="category__item">
                            <a href="/product.php?category=1&name=Имплантология" class="category__link">
                                <div class="category-img__wrapper">
                                    <img src="uploads/implantologia.png" alt="" class="category__image">
                                </div>
                                <div class="category-text__wrapper">
                                    <span class="category__title">Имплантология</span>
                                </div>
                            </a>
                        </li>
                                            <li class="category__item">
                            <a href="/product.php?category=10&name=Медицинская оптика" class="category__link">
                                <div class="category-img__wrapper">
                                    <img src="uploads/optika.png
" alt="" class="category__image">
                                </div>
                                <div class="category-text__wrapper">
                                    <span class="category__title">Медицинская оптика</span>
                                </div>
                            </a>
                        </li>
                                            <li class="category__item">
                            <a href="/product.php?category=9&name=Стерилизация и дезинфекция" class="category__link">
                                <div class="category-img__wrapper">
                                    <img src="uploads/sterilanddezif.png" alt="" class="category__image">
                                </div>
                                <div class="category-text__wrapper">
                                    <span class="category__title">Стерилизация и дезинфекция</span>
                                </div>
                            </a>
                        </li>
                                            <li class="category__item">
                            <a href="/product.php?category=4&name=Стоматологические инструменты" class="category__link">
                                <div class="category-img__wrapper">
                                    <img src="uploads/terapiatolls.png" alt="" class="category__image">
                                </div>
                                <div class="category-text__wrapper">
                                    <span class="category__title">Стоматологические инструменты</span>
                                </div>
                            </a>
                        </li>
                                            <li class="category__item">
                            <a href="/product.php?category=5&name=Стоматологические материалы" class="category__link">
                                <div class="category-img__wrapper">
                                    <img src="uploads/stomteh.png" alt="" class="category__image">
                                </div>
                                <div class="category-text__wrapper">
                                    <span class="category__title">Стоматологические материалы</span>
                                </div>
                            </a>
                        </li>
                                            <li class="category__item">
                            <a href="/product.php?category=2&name=Стоматологические установки" class="category__link">
                                <div class="category-img__wrapper">
                                    <img src="uploads/zuboustanovka.png" alt="" class="category__image">
                                </div>
                                <div class="category-text__wrapper">
                                    <span class="category__title">Стоматологические установки</span>
                                </div>
                            </a>
                        </li>
                                            <li class="category__item">
                            <a href="/product.php?category=3&name=Стоматологическое оборудование" class="category__link">
                                <div class="category-img__wrapper">
                                    <img src="uploads/zuboborudovanie.png" alt="" class="category__image">
                                </div>
                                <div class="category-text__wrapper">
                                    <span class="category__title">Стоматологическое оборудование</span>
                                </div>
                            </a>
                        </li>
                                            <li class="category__item">
                            <a href="/product.php?category=8&name=Шовный материал" class="category__link">
                                <div class="category-img__wrapper">
                                    <img src="uploads/shovmaterial.png" alt="" class="category__image">
                                </div>
                                <div class="category-text__wrapper">
                                    <span class="category__title">Шовный материал</span>
                                </div>
                            </a>
                        </li>
                                    </ul>
