...
function content_648f9232014274_52421238 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="ru">
    ...
    <main class="main__section admin__section">
        ...
        <div class="container">
            ...
            <table class="table table-hover table-responsive table-bordered">
                        ...
                        <td>ID товара</td>
                        <td>
                            24 - Автоклав Statim 2000 S кассетный, объём 1,8 л
                        </td>
                    </tr>
                    <tr>
