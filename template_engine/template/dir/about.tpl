                    ...
                    {foreach from=$news item=item key=key name=name}
                        <li class="news__item">
                            <article class="news__article article">
                                <img src="uploads/{$item.img}" alt="" class="article__img">
                                <div class="article__info-wrapper">
                                    <time datetime="2022-11-30" class="article__time">
                                        {$item.date|date_format:"%d.%m.%Yг"}
                                    </time>
                                    <h4 class="article__header">{$item.header}</h4>
                                    <div class="article__sub-wrapper asub">
                                        <div class="asub__info-wrapper ainfo">
                                            ...
                                            <span class="ainfo__span">{$item.views}</span>
                                        </div>
                                        <a href="read-news?id={$item.id}" class="ainfo__link">Подробнее</a>
                                    </div>
                                </div>
                            </article>
                        </li>
