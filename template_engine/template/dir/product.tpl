    ...
    <main class="main">
        ...
        <section class="main__section about-us__section product__welcome">
            ...
            <div class="container about-us__container">
                ...
                <h2 class="about-us__header">{$name}</h2>
            </div>
                    ...
                    {foreach from=$products item=item key=key name=name}
                        ...
                        <li class="new-product__item">
                            <div class="new-product__top">
                                <a href="product_page?id={$item.id_product}" class="new-product__photo">
                                    <img src="uploads/{$item.img}" alt="" class="new-product__image">
                                </a>
                                ...
                                <div class="new-product__name">
                                    <a href="product_page?id={$item.id_product}">{$item.full_name}</a>
                                </div>
                                <div class="new-product__small">
                                    Производитель:
                                    <a href="">{$item.man_name}</a>
                                </div>
                                <div class="new-product__small">
                                    Cтрана: {$item.country}
                                </div>
                            ...
                            <div class="new-product__bottom">
                                <a href="#exampleModal" class="button new-product__button" id="product__link"
                                    data-bs-toggle="modal" data-id="{$item.id}" data-name="{$item.full_name}">Запросить
                                    КП</a>
                            </div>
                        </li>
